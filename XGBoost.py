...
def train_evaluate_xgb(x_train_main, x_train_holdout, y_train_main, y_train_holdout):
    # Find optimised paramters for XG Boost
    def objective(trial):
        params = {
        ...
        score = weighted_log_loss(one_hot_labels, pred_probs)
...
if __name__ == "__main__":
    ...
    # # Evaluate
    # raw_metrics, raw_best_params = train_evaluate_xgb(x_train_main, x_train_holdout, y_train_main, y_train_holdout)
    ...
    # Evaluate
    scaled_metrics, scaled_best_params = train_evaluate_xgb(x_train_main, x_train_holdout, y_train_main, y_train_holdout)
    ...
    # # Evaluate
    # processed_metrics, processed_best_params = train_evaluate_xgb(x_train_main, x_train_holdout, y_train_main, y_train_holdout)
    ...
    with open("best_params/xgb.json", "w") as f:
